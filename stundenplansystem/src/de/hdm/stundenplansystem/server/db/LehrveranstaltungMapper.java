 ...
 * VerfÃ¼gung gestellt, mit deren Hilfe z.B. Objekte gesucht, erzeugt,
 * modifiziert und gelÃ¶scht werden kÃ¶nnen. Das Mapping ist bidirektional.
 * D.h., Objekte kÃ¶nnen in DB-Strukturen und DB-Strukturen in Objekte
 * umgewandelt werden.
 * 
...
public class LehrveranstaltungMapper {
	 ...
	 * stellt die Singleton-Eigenschaft sicher, indem Sie dafÃ¼r sorgt, dass nur
	 ...
	 * @return Lehrveranstaltung-Objekt, das dem Ã¼bergebenen SchlÃ¼ssel
	 ...
	 * 
	 * @return Ein Vektor mit Lehrveranstaltung-Objekten, die sÃ¤mtliche
	 *         Lehrveranstaltungen reprÃ¤sentieren. Bei evtl. Exceptions wird
	...
	/**
	 * EinfÃ¼gen eines <code>Lehrveranstaltung</code>-Objekts in die Datenbank.
	...
	public Lehrveranstaltung insert(Lehrveranstaltung l) {
		 ...
		 * Lehrveranstaltung-Objekts auch ohne diese explizite RÃ¼ckgabe
		 * auï¿½erhalb dieser Methode sichtbar. Die explizite RÃ¼ckgabe von l
	...
	/**
	 * LÃ¶schen der Daten eines <code>Lehrveranstaltung</code>-Objekts aus der
	 * Datenbank.
	 * 
	 * @param l
