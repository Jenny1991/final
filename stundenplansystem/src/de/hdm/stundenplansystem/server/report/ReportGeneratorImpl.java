...
public class ReportGeneratorImpl extends RemoteServiceServlet
	...
	public void init() throws IllegalArgumentException {
		 ...
		 * eine VerwaltungklasseImpl-Instanz.
		 */
	...
	public StundenplanDozentReport createStundenplanDozentReport(
		 ...
		 * Stundenplaneintrag-Informationen.
		 */

		/*
		 * Zunächst legen wir eine Kopfzeile für die Stundenplaneintrag-Tabelle
		 * an.
		 */
		...
		/*
		 * hilfsvariable für den Zeitslot mit ihrer Hilfe kann an jedem
		 * Zeilenanfang die richtige Uhrzeit geschrieben werden.
		 */
	...
	public RaumbelegungsReport createRaumbelungsReport(int raumId)
		...
		/*
		 * Nun werden sämtliche Stundenplaneintraege des Raumes ausgelesen und
		 * in die Tabelle eingetragen. Dabei läuft die For-Schleife die Anzahl
		 * der Zeitslot durch und überprüft auf vorhandene Daten.
		 */
	...
	public StundenplanSemesterverbandReport createStundenplanSemesterverbandReport(
		...
		Semesterverband sv = verwaltung
				.getSemesterverbandById(semesterverbandId);
		...
		/*
		 * Nun werden sämtliche Stundenplaneintraege des Semesterverbandes
		 * ausgelesen und in die Tabelle eingetragen. Dabei läuft die
		 * For-Schleife die Anzahl der Zeitslot durch und überprüft auf
		 * vorhandene Daten.
		 */
		...
		for (int i = 1; i < 37; i++) {
			...
			Stundenplaneintrag aktuell = this.verwaltung
					.getStundenplaneintragBySemesterverbandAndZeitslot(
							sv.getId(), i, sp.getId());
