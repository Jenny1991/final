...
public interface Verwaltungsklasse extends RemoteService {
	...
	public Vector<Zeitslot> getFreieZeitslot(int raumId, int dozentId, int stundenplanId) throws IllegalArgumentException;
	...
	public Studiengang getStudiengangBySemesterverbandId(int SemesterverbandId) throws IllegalArgumentException;
