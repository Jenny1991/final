...
public interface VerwaltungsklasseAsync {
	...
	void createLehrveranstaltung(String bezeichnung, int semester,
	...
	void createRaum(String bezeichnung, int kapazitaet,
	...
	void getAllLehrveranstaltungen(
			AsyncCallback<Vector<Lehrveranstaltung>> callback);

	void getAllRaeume(AsyncCallback<Vector<Raum>> callback);

	void getAllSemesterverbaende(
			AsyncCallback<Vector<Semesterverband>> callback);

	void getAllStudiengaenge(
			AsyncCallback<Vector<Studiengang>> callback);

	void getAllStundenplaene(
	...
	void getStudiengangById(int id,
			AsyncCallback<Studiengang> callback);

	void getSemesterverbandById(int id,
			AsyncCallback<Semesterverband> callback);

	void getStundenplaneintragById(int id,
			AsyncCallback<Stundenplaneintrag> callback);

	void getStundenplanById(int id,
	...
	void setSemesterverband(Semesterverband s,
			AsyncCallback<Void> callback);
	...
	void getStundenplaeneBySemesterverband(int semesterverbandId,
			AsyncCallback<Vector<Stundenplan>> callback);
	...
	void getAllStundenplaneintraegeByLehrveranstaltung(
	...
	void getFreieZeitslot(int raumId, int dozentId,
			String studienhalbjahr, int stundenplanId,
