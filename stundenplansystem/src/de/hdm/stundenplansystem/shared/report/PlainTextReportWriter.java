...
public class PlainTextReportWriter extends ReportWriter {
	...
	/**
	 * Prozessieren des ����bergebenen Reports und Ablage im Zielformat. Ein
	 * Auslesen des Ergebnisses kann sp����ter mittels
	...
	public void process(StundenplanDozentReport r) {
		...
		// Zun����chst l����schen wir das Ergebnis vorhergehender
		// Prozessierungen.
		this.resetReportText();

		/*
		 * In diesen Buffer schreiben wir w����hrend der Prozessierung
		 * sukzessive unsere Ergebnisse.
		 */
		StringBuffer result = new StringBuffer();

		/*
		 * Nun werden Schritt f����r Schritt die einzelnen Bestandteile des
		 * Reports ausgelesen und in Text-Form ����bersetzt.
		 */
